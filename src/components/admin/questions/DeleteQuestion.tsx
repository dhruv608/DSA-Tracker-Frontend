...
import { Question } from '@/types/admin/question.types';
...
export default function DeleteQuestion({
  ...
  // Handle Enter key to trigger delete
  useEffect(() => {
  ...
  }, [open, loading, question]);

  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[440px] max:h-[90vh] p-0  rounded-2xl">
